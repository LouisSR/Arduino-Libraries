...
#define COM_IN_LENGTH 5 // Length of I2C recieved data
#define COM_OUT_LENGTH 10 // Length of I2C sent data
#define COM_OVERHEAD 2
#define START_BYTE 15
	

void i2cBegin(uint8_t slaveAdress);
bool i2cGetMessage(uint8_t* message);
